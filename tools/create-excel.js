...
const DAYS = [
  {
    ...
    activities:[
      { type:'note',    text:"נחיתה בשדה התעופה של סולט לייק סיטי (SLC) בשעה 9:35 בבוקר. תכנני כשעה וחצי לירידה מהמטוס, לקבלת המזוודות ולקיחת הרכב השכור לפני היציאה לדרך.", duration:'~1.5 hrs', time:'9:35 AM' },
      { type:'driving', text:"לקיחת הרכב השכור בשדה התעופה של סולט לייק סיטי, ויציאה לדרך — נסיעה של כשלוש וחצי שעות דרומה למואב שביוטה. הכביש עובר דרך הרים וקניונים יפהפיים — תיהני מהנוף בדרך.", duration:'~3.5 hrs', time:'~11:00 AM' },
      { type:'keep',    text:'Sun Outdoor Arches Gateway — מואב, יוטה', duration:'', time:'~3:00 PM' },
    ],
  },
  {
    day:2, date:'2026-05-06', title:'Arches National Park', wakeup:'6:00 AM', depart:'7:00 AM',
    activities:[
      { type:'driving', text:"נסיעה של 15 דקות מהמלון אל הכניסה לפארק Arches.", duration:'15 min', time:'7:00 AM' },
      { type:'stop',    text:"עצירה ב-Arches Visitor Center לקבלת כרטיס הכניסה לפארק ומפה.", duration:'10 min', time:'7:20 AM' },
      { type:'hike',    text:"Park Avenue Trail — הליכה בין חומות אבן חול גבוהות, כמו פרוזדור טבעי שנחצב ע\"י הטבע. שטוח וקל.", duration:'1.5 hrs', time:'7:35 AM' },
      { type:'driving', text:"ממשיכים לעומק הפארק, הרי La Sal מופיעים מימין — להישאר ברכב וליהנות מהנוף דרך החלון.", duration:'5 min', time:'9:10 AM' },
      { type:'stop',    text:"Courthouse Towers — לעצור בצד הדרך, להסתכל על מגדלי הסלע האדומים העצומים שעולים מהמדבר, ולצלם.", duration:'10 min', time:'9:15 AM' },
      { type:'walk',    text:"Balanced Rock — לולאה קצרה וקלה סביב סלע ענק מפורסם המאוזן בצורה מושלמת על בסיס דק.", duration:'20 min', time:'9:30 AM' },
      { type:'walk',    text:"אזור ה-Windows — מחניה אחת הולכים לשלוש קשתות שונות: Turret Arch, ה-Windows Loop, ו-Double Arch. אפשר לעמוד מתחת לכמה מהן — הן ענקיות.", duration:'1.5 hrs', time:'10:00 AM' },
      { type:'hike',    text:"Delicate Arch Trail — הקשת המפורסמת בעולם. הליכה תלולה על סלע חשוף בשמש. לקחת מים נוספים. שווה כל צעד.", duration:'2.5–3 hrs', time:'11:45 AM' },
      { type:'stop',    text:"Fiery Furnace Viewpoint — לעצור בצד הדרך ולהסתכל מגדר אל המבוך הצר של סנפירי הסלע. בלי סיור מודרך אסור להיכנס.", duration:'10 min', time:'2:40 PM' },
      { type:'stop',    text:"Skyline Arch — נראית מהכביש. לעצור לרגע לצילום.", duration:'5 min', time:'2:52 PM' },
      { type:'walk',    text:"Sand Dune Arch + Broken Arch — שתי קשתות על שביל צד קצר ליד הכביש. Sand Dune היא הליכה של 0.4 מייל דרך חול עמוק אל קשת קטנה החבויה בין סנפירי סלע (קריר ומוצל — הילדים אוהבים את החול). Broken Arch היא עוד 0.4 מייל על סלע חשוף אל קשת גדולה. בדרך כלל משלבים את שתיהן בעצירה אחת.", duration:'45 min', time:'3:00 PM', change:'🆕 NEW ROW — added Sand Dune Arch + Broken Arch (mom asked where they were)' },
      { type:'hike',    text:"Devils Garden — המסלול הטוב ביותר בכל Arches. בדרך פנימה עוברים על-יד Tunnel Arch ו-Pine Tree Arch, ואז מגיעים ל-Landscape Arch (הקשת הטבעית הארוכה בעולם). משם המסלול הפרימיטיבי ממשיך עמוק יותר אל Partition Arch, Navajo Arch, Double O Arch, Dark Angel ו-Private Arch — כל קשת בצורה שונה, והמסלול נעשה שקט ומבודד יותר ככל שמתקדמים.", duration:'2–4 hrs', time:'3:50 PM', change:'✏️ EXPANDED — named 8 individual arches on the trail (Pine Tree, Partition, Navajo, Dark Angel, Private, etc.)' },
      { type:'keep',    text:'Sun Outdoors Arches Gateway — מואב, יוטה (אותו מלון)', duration:'', time:'~7:00 PM', change:'⏰ TIME UPDATED — ~6:30 PM → ~7:00 PM (longer day with added arches)' },
    ],
  },
  {
    day:3, date:'2026-05-07', title:'Canyonlands + Fiery Furnace', wakeup:'6:30 AM', depart:'7:20 AM',
    activities:[
      { type:'driving', text:"נסיעה של 35 דקות מהמלון לתוך פארק Arches עד לחניה של Fiery Furnace. הכרטיס לפארק כבר ברשותך מאתמול — אין צורך לעצור ב-Visitor Center. לצלם screenshot לכרטיס מ-Recreation.gov לפני הנסיעה פנימה (קליטה סלולרית חלשה בטרילהד).", duration:'35 min', time:'7:20 AM', change:"🆕 NEW ROW — drive into Arches to Fiery Furnace TH (mom insisted on adding the self-guided permit hike)" },
      { type:'hike',    text:"Self-Guided Fiery Furnace Exploration — היתר מאושר ל-2 מבוגרים, התחלה ב-8:00 בבוקר. מציאת דרך עצמאית במבוך של סנפירי אבן חול על סלע חשוף. אין שביל מסומן — מעברים צרים בין קירות, קפיצות קטנות בין סלעים, מדרגות סלע. כשני מייל הלוך-חזור, אבל לוקח הרבה יותר זמן ממה שהמרחק מרמז כי מנווטים בעיניים. לתכנן 3.5 שעות מלאות. לקחת מים, חטיפים ונעליים עם אחיזה טובה. לא טיול קליל — זה האתגרי שאמא ביקשה.", duration:'3.5 hrs', time:'8:00 AM', change:"🆕 NEW ROW — Self-Guided Fiery Furnace Exploration (added 2026-05-01 after permit booked)" },
      { type:'driving', text:"נסיעה של כ-55 דקות מ-Fiery Furnace ל-Dead Horse Point — יציאה מ-Arches דרומה בכביש הפארק, מקטע קצר צפונה בכביש 191, ואז מערבה בכביש 313 לרוחב המֵסָה.", duration:'55 min', time:'11:30 AM', change:"🔁 ROUTE CHANGE — was 'Moab → DHP 30 min'; now 'Fiery Furnace TH → DHP 55 min'" },
      { type:'stop',    text:"Dead Horse Point — הליכה לשפת הקניון. נהר הקולורדו זורם 2,000 רגל למטה בעיקול בצורת פרסה. אחת הנקודות העוצרות נשימה ביוטה. ארוחת צהריים קצרה מהקולמן על ספסל בשפת הקניון.", duration:'60 min', time:'12:25 PM', change:"⏰ TIME + DURATION — was 8:30 AM 45–90 min; trimmed to 60 min + shifted to fit Fiery Furnace morning" },
      { type:'driving', text:"נסיעה של 15 דקות מ-Dead Horse Point לכניסה של Canyonlands Island in the Sky.", duration:'15 min', time:'1:25 PM', change:"⏰ TIME — was 10:00 AM" },
      { type:'stop',    text:"Shafer Canyon Overlook — לעצור בצד ולהסתכל למטה על הכביש שמתפתל אל תוך הקניון הרחק מתחת.", duration:'10 min', time:'1:40 PM', change:"⏰ TIME — was 10:15 AM" },
      { type:'stop',    text:"Gooseneck Overlook — נהר הקולורדו מתפתל ב-270 מעלות ללולאה צרה למטה. דרמטי מאוד.", duration:'10 min', time:'1:52 PM', change:"⏰ TIME — was 10:27 AM" },
      { type:'driving', text:"נסיעה של 20 דקות לרוחב המֵסָה אל Upheaval Dome בקצה השני של הפארק.", duration:'20 min', time:'2:02 PM', change:"⏰ TIME — was 10:37 AM" },
      { type:'walk',    text:"Upheaval Dome — הליכה קצרה אל שפת מכתש מסתורי. מדענים לא בטוחים אם מטאוריט יצר אותו או כיפת מלח — כך או כך, זה נראה כמו משהו מכוכב לכת אחר.", duration:'45 min', time:'2:22 PM', change:"⏰ TIME — was 11:00 AM" },
      { type:'walk',    text:"Whale Rock — כיפת אבן חול גדולה בצורת לוויתן ממש ליד Upheaval Dome. שביל קצר של מייל אחד עם טיפוס קל על סלע חשוף. מהפסגה רואים את Upheaval Dome מלמעלה — הנוף הטוב ביותר.", duration:'45 min', time:'3:07 PM', change:"⏰ TIME — was 11:45 AM" },
      { type:'driving', text:"חזרה לרוחב המֵסָה לכיוון נקודות התצפית הראשיות.", duration:'20 min', time:'3:52 PM', change:"⏰ TIME — was 12:30 PM" },
      { type:'walk',    text:"Mesa Arch — הליכה קלה של חצי מייל אל קשת אבן חול שמסגרת את הקניון 1,000 רגל למטה.", duration:'25 min', time:'4:12 PM', change:"⏰ TIME — was 12:50 PM" },
      { type:'stop',    text:"Green River Overlook, Murphy Point ו-Buck Canyon Overlook — לעצור בכל אחת משלוש הנקודות לתצפיות על הקניון. כל אחת היא הליכה קצרה מהרכב.", duration:'10–15 min each', time:'4:37 PM', change:"⏰ TIME — was 1:20 PM" },
      { type:'stop',    text:"White Rim Overlook — הליכה קלה של 0.9 מייל אל נקודה עם תצפית ישרה למטה אל White Rim Road שמתפתלת בקניון. מקום טוב לשבת ולראות עד כמה הקניון עמוק.", duration:'30 min', time:'5:07 PM', change:"⏰ TIME — was 1:50 PM" },
      { type:'note',    text:"Musselman Arch — קשת ארוכה ושטוחה ומפורסמת שאולי קראת עליה. היא נמצאת על White Rim Road כ-1,000 רגל מתחתייך. נסיעה אליה דורשת רכב 4X4 והיתר — לא אפשרי ברכב השכור שלכם. ביום צלול אפשר לראות את הצד העליון שלה מחלק מנקודות התצפית.", duration:'', time:'' },
      { type:'walk',    text:"Grand View Point — סוף הכביש הראשי. הליכה לאורך שפת הקניון לכל הכיוונים. התצפיות הפנורמיות הטובות ביותר ב-Canyonlands.", duration:'45 min', time:'5:37 PM', change:"⏰ TIME — was 2:25 PM" },
      { type:'driving', text:"נסיעה של כ-30 דקות דרומה בכבישים 313/191 חזרה למואב.", duration:'30 min', time:'6:22 PM', change:"🗑️ REPLACED — old Hwy 128/Fisher Towers segment removed (Fisher Towers dropped to fit Fiery Furnace morning)" },
      { type:'keep',    text:'The Bowen Motel — מואב, יוטה', duration:'', time:'~6:55 PM', change:'⏰ TIME UPDATED — ~5:45 PM → ~6:55 PM (Fiery Furnace adds ~1hr net to the day)' },
    ],
  },
  {
