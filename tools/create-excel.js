...
const DAYS = [
  {
    ...
    activities:[
      { type:'note',    text:"Land at Salt Lake City Airport (SLC) at 9:35 AM. Plan ~1.5 hours for deplaning, baggage claim, and rental-car pickup before starting the drive.", duration:'~1.5 hrs', time:'9:35 AM' },
      { type:'driving', text:"Pick up the rental car at Salt Lake City Airport. Then drive about 3.5 hours south to Moab, Utah. The highway passes through beautiful mountain and canyon country — enjoy the scenery on the way in.", duration:'~3.5 hrs', time:'~11:00 AM' },
      { type:'keep',    text:'Sun Outdoor Arches Gateway — Moab, UT', duration:'', time:'~3:00 PM' },
    ],
  },
  {
    day:2, date:'2026-05-06', title:'Arches National Park', wakeup:'6:00 AM', depart:'7:00 AM',
    activities:[
      { type:'driving', text:"Drive 15 minutes from the hotel to Arches National Park entrance.", duration:'15 min', time:'7:00 AM' },
      { type:'stop',    text:"Stop at the Arches Visitor Center to pick up your park pass and map.", duration:'10 min', time:'7:20 AM' },
      { type:'hike',    text:"Park Avenue Trail — walk between towering sandstone walls, like a natural hallway carved by nature. Flat and easy.", duration:'1.5 hrs', time:'7:35 AM' },
      { type:'driving', text:"As you drive deeper into the park, the La Sal Mountains appear to your right — stay in the car and enjoy the view through the window.", duration:'5 min', time:'9:10 AM' },
      { type:'stop',    text:"Courthouse Towers — pull over, look at the tall red rock towers rising from the desert, take a photo.", duration:'10 min', time:'9:15 AM' },
      { type:'walk',    text:"Balanced Rock — a short easy loop around a famous giant rock perfectly balanced on a thin base.", duration:'20 min', time:'9:30 AM' },
      { type:'walk',    text:"Windows section — from one parking area you walk to three different arches: Turret Arch, the Windows Loop, and Double Arch. You can stand under some of them — they are enormous.", duration:'1.5 hrs', time:'10:00 AM' },
      { type:'hike',    text:"Delicate Arch Trail — the most famous arch in the world. A steep walk on open slickrock in the sun. Bring extra water. Worth every step.", duration:'2.5–3 hrs', time:'11:45 AM' },
      { type:'stop',    text:"Fiery Furnace Viewpoint — pull over and look into the narrow maze of rock fins from a fence. You cannot enter without a guided tour.", duration:'10 min', time:'2:40 PM' },
      { type:'stop',    text:"Skyline Arch — visible from the road. Pull over for a quick photo.", duration:'5 min', time:'2:52 PM' },
      { type:'walk',    text:"Sand Dune Arch + Broken Arch — two arches on a short side trail near the road. Sand Dune is a 0.4mi walk through deep sand to a small arch sheltered between rock fins (cool and shaded — kids love the sand). Broken Arch is another 0.4mi across slickrock to a large arch. They are usually combined in one stop.", duration:'45 min', time:'3:00 PM', change:'🆕 NEW ROW — added Sand Dune Arch + Broken Arch (mom asked where they were)' },
      { type:'hike',    text:"Devils Garden — the best trail in all of Arches. On the way in you pass Tunnel Arch and Pine Tree Arch, then reach Landscape Arch (the longest natural arch in the world). From there the primitive trail continues deeper to Partition Arch, Navajo Arch, Double O Arch, Dark Angel, and Private Arch — each arch a different shape, and the trail grows quieter and more remote the further you go.", duration:'2–4 hrs', time:'3:50 PM', change:'✏️ EXPANDED — named 8 individual arches on the trail (Pine Tree, Partition, Navajo, Dark Angel, Private, etc.)' },
      { type:'keep',    text:'Sun Outdoors Arches Gateway — Moab, UT (same hotel)', duration:'', time:'~7:00 PM', change:'⏰ TIME UPDATED — ~6:30 PM → ~7:00 PM (longer day with added arches)' },
    ],
  },
  {
    day:3, date:'2026-05-07', title:'Canyonlands + Fiery Furnace', wakeup:'6:30 AM', depart:'7:20 AM',
    activities:[
      { type:'driving', text:"Drive 35 minutes from the hotel into Arches National Park to the Fiery Furnace parking lot. You already have your park pass from yesterday — no need to stop at the Visitor Center. Take a screenshot of the Recreation.gov ticket before driving in (cell service is poor at the trailhead).", duration:'35 min', time:'7:20 AM', change:"🆕 NEW ROW — drive into Arches to Fiery Furnace TH (mom insisted on adding the self-guided permit hike)" },
      { type:'hike',    text:"Self-Guided Fiery Furnace Exploration — confirmed permit Rec.gov #0816993222-1, 8:00 AM start, 2 adults. Route-find through a maze of sandstone fins on slickrock. No marked trail — narrow squeezes between walls, small jumps between rocks, ledges. Roughly 2 miles round trip but takes much longer than the distance suggests because you navigate visually. Plan a full 3.5 hours. Bring water, snacks, and grippy shoes. NOT a casual walk — this is the strenuous one mom asked for.", duration:'3.5 hrs', time:'8:00 AM', change:"🆕 NEW ROW — Self-Guided Fiery Furnace Exploration (added 2026-05-01 after permit booked)" },
      { type:'driving', text:"Drive ~55 minutes from Fiery Furnace to Dead Horse Point — exit Arches south on the park road, north a short stretch on Highway 191, then west on Highway 313 across the mesa.", duration:'55 min', time:'11:30 AM', change:"🔁 ROUTE CHANGE — was 'Moab → DHP 30 min'; now 'Fiery Furnace TH → DHP 55 min'" },
      { type:'stop',    text:"Dead Horse Point — walk to the canyon rim. The Colorado River flows 2,000 feet below in a horseshoe bend. One of the most breathtaking views in Utah. Quick lunch from the cooler on a bench at the rim.", duration:'60 min', time:'12:25 PM', change:"⏰ TIME + DURATION — was 8:30 AM 45–90 min; trimmed to 60 min + shifted to fit Fiery Furnace morning" },
      { type:'driving', text:"Drive 15 minutes from Dead Horse Point to the Canyonlands Island in the Sky entrance.", duration:'15 min', time:'1:25 PM', change:"⏰ TIME — was 10:00 AM" },
      { type:'stop',    text:"Shafer Canyon Overlook — pull over and look down at the road that spirals into the canyon far below.", duration:'10 min', time:'1:40 PM', change:"⏰ TIME — was 10:15 AM" },
      { type:'stop',    text:"Gooseneck Overlook — the Colorado River bends 270 degrees into a tight loop below you. Very dramatic.", duration:'10 min', time:'1:52 PM', change:"⏰ TIME — was 10:27 AM" },
      { type:'driving', text:"Drive 20 minutes across the mesa to Upheaval Dome on the far side of the park.", duration:'20 min', time:'2:02 PM', change:"⏰ TIME — was 10:37 AM" },
      { type:'walk',    text:"Upheaval Dome — a short walk to the edge of a mysterious crater. Scientists are not sure if a meteor made it or a salt dome — either way, it looks like something from another planet.", duration:'45 min', time:'2:22 PM', change:"⏰ TIME — was 11:00 AM" },
      { type:'walk',    text:"Whale Rock — a big whale-shaped sandstone dome right next to Upheaval Dome. Short 1-mile trail with some easy scrambling up the slickrock. From the top you get the best view of Upheaval Dome from above.", duration:'45 min', time:'3:07 PM', change:"⏰ TIME — was 11:45 AM" },
      ...
      { type:'walk',    text:"Mesa Arch — a half-mile easy walk to a sandstone arch framing the canyon 1,000 feet below.", duration:'25 min', time:'4:12 PM', change:"⏰ TIME — was 12:50 PM" },
      { type:'stop',    text:"Green River Overlook, Murphy Point, and Buck Canyon Overlook — pull over at each of these three spots for canyon views. Each is a short walk from the car.", duration:'10–15 min each', time:'4:37 PM', change:"⏰ TIME — was 1:20 PM" },
      { type:'stop',    text:"White Rim Overlook — short 0.9-mile easy walk out to a point with a clear view straight down onto the White Rim Road winding through the canyon below. Good spot to sit and see how far the canyon drops.", duration:'30 min', time:'5:07 PM', change:"⏰ TIME — was 1:50 PM" },
      { type:'note',    text:"Musselman Arch — a famous long flat arch you may have read about. It sits on the White Rim Road about 1,000 feet below you. Driving to it requires a 4WD vehicle and a permit — NOT doable in your rental car. You can see the top of it from some of the rim overlooks on a clear day.", duration:'', time:'' },
      { type:'walk',    text:"Grand View Point — the end of the main road. Walk along the canyon rim in all directions. The best panoramic views in Canyonlands.", duration:'45 min', time:'5:37 PM', change:"⏰ TIME — was 2:25 PM" },
      { type:'driving', text:"Drive ~30 minutes south on Hwy 313/191 back into Moab.", duration:'30 min', time:'6:22 PM', change:"🗑️ REPLACED — old Hwy 128/Fisher Towers segment removed (Fisher Towers dropped to fit Fiery Furnace morning)" },
      { type:'keep',    text:'The Bowen Motel — Moab, UT', duration:'', time:'~6:55 PM', change:'⏰ TIME UPDATED — ~5:45 PM → ~6:55 PM (Fiery Furnace adds ~1hr net to the day)' },
    ],
  },
  {
...
async function build() {
  ...
  const recs = [
    { _s:'⚠️  MISSING STOPS — HIGH IMPACT' },
    { p:'HIGH', t:'Add Stop', w:'Day 4 or 5\nFri May 8 / Sat May 9\n(Cathedral Valley Inn)', n:'Temple of the Sun\nCathedral Valley', y:"She sleeps 3 nights at Cathedral Valley Inn and has ZERO Cathedral Valley stops planned. A 400-ft isolated red monolith in Capitol Reef's north district. Almost nobody goes here.", a:'Hartnet Road north from Caineville. Dirt road, OK when dry. All 3 Cathedral Valley sites in one 4-5 hr loop.', lat:38.298, lng:-111.122 },
    { p:'HIGH', t:'Add Stop', w:'Day 4 or 5\nFri May 8 / Sat May 9', n:'Temple of the Moon\nCathedral Valley', y:'Companion formation to Temple of the Sun on the same loop road.', a:'Same Hartnet Road loop. Visit with Temple of Sun and Gypsum Sinkhole.', lat:38.297, lng:-111.120 },
    { p:'HIGH', t:'Add Stop', w:'Day 4 or 5\nFri May 8 / Sat May 9', n:'Gypsum Sinkhole\nCathedral Valley', y:'A massive crater in the flat valley floor — very eerie and unusual.', a:'On the same loop road as the Temples.', lat:38.305, lng:-111.100 },
    { _s:'⚠️  ZION — DAYS 19 & 20 HAVE NO CONTENT PLANNED' },
    { p:'HIGH', t:'Fill Empty Day', w:'Day 19\nSat May 23\n(Zion)', n:'Angels Landing Trail', y:"One of the most famous hikes in the US. Chains on the final section to a narrow summit ridge. Not in the itinerary at all.", a:'Permit required — book at recreation.gov > Zion NP > Angels Landing. Alternative: Observation Point (no permit, even better view).', lat:37.269, lng:-112.948 },
    { p:'HIGH', t:'Fill Empty Day', w:'Day 19 or 20\n(Zion)', n:'The Narrows\n(Temple of Sinawava)', y:'Walk up the Virgin River through slot canyon walls — unique experience. No permit needed.', a:"Rent neoprene wetsuit in Springdale — May water is ~45°F cold. Take shuttle to last stop (Temple of Sinawava). Budget 4-6 hrs.", lat:37.298, lng:-112.948 },
    { p:'HIGH', t:'Fill Empty Day', w:'Day 20\nSun May 24\n(Zion)', n:'Emerald Pools Trails', y:'Three tiered pools with waterfalls. Beautiful and accessible. Not in the itinerary.', a:'Lower Pool: Easy 0.6mi. Middle: 1.0mi. Upper: 1.2mi. Take shuttle to The Grotto stop.', lat:37.255, lng:-112.957 },
    { p:'MEDIUM', t:'Fill Empty Day', w:'Day 19\nSat May 23\n(arriving via Hwy 9)', n:'Canyon Overlook Trail', y:'Short 1-mile trail to sweeping canyon view. Good warm-up. No shuttle needed.', a:'Trailhead at east side of Zion-Mt Carmel Tunnel on Hwy 9.', lat:37.220, lng:-112.943 },
    { _s:'🏨  SLEEPING CHANGES' },
    { p:'HIGH', t:'Sleeping Change', w:'Days 19–20\nMay 23–24', n:'CANCEL Economy Inn & Suites\nBook Springdale hotel instead', y:'St. George is 45+ min from the Zion shuttle. Springdale is 5 minutes — enables early start for Angels Landing and full day in the canyon.', a:'Hampton Inn Springdale or similar. Essential if Angels Landing permit is obtained (must start by 7am).', lat:37.199, lng:-112.988 },
    { p:'MEDIUM', t:'Sleeping Change', w:'Day 14 area\nMon May 18', n:'Optional: Add Monument Valley night\n(The View Hotel)', y:'The iconic Mittens photo requires golden hour light. Arriving midday gives flat harsh light.', a:'The View Hotel (Navajo Nation) on the canyon rim. Book far in advance. At minimum arrive by 6pm for golden hour.', lat:36.999, lng:-110.113 },
    { _s:'🔧  DATA ERRORS — Fix or Remove Before the Trip' },
    { p:'FIX', t:'Remove', w:'Day 5 — Sat May 9', n:'REMOVE: Cosmic Ash Hills Walk Utah', y:'No such trail exists anywhere.', a:'Remove from itinerary.', lat:'', lng:'' },
    { p:'FIX', t:'Fix Coords', w:'Day 5 — Sat May 9', n:'FIX: Rainbow Hills Loop — wrong coordinates', y:'Coordinates are ~80 miles off (pointing near St. George).', a:"Ask mom to find the article she read — need to verify exact location.", lat:'', lng:'' },
    { p:'FIX', t:'Fix Coords', w:'Day 6 — Sun May 10', n:'FIX: Carmel Canyon Loop Utah', y:'Coordinates point to St. George — 170 miles off. Will break navigation.', a:'Correct coordinates: approx (38.570, -110.710) in Goblin Valley.', lat:38.570, lng:-110.710 },
    { p:'DONE', t:'Removed', w:'Day 21 — Mon May 25', n:'REMOVED: Petrified Logs Kanarra Falls', y:'Petrified logs are real — but they are at Escalante Petrified Forest State Park, not at Kanarra Falls. ChatGPT confused two places.', a:'✅ Removed from itinerary 2026-05-01. Petrified logs not visited on this trip.', lat:'', lng:'' },
    { p:'DONE', t:'Removed', w:'Day 21 — Mon May 25', n:'REMOVED: Seven Wonders Kanarra Falls', y:'Seven Wonders is a real loop — but it is at Valley of Fire (near the Fire Wave trailhead), not at Kanarra Falls.', a:'✅ Removed from itinerary 2026-05-01. The Fire Wave stop on Day 21 already passes through this area — no plan change needed, just renamed correctly.', lat:'', lng:'' },
    { p:'DONE', t:'Renamed', w:'Day 21 — Mon May 25', n:'RENAMED: Elephant Rock — Valley of Fire\n(was: "Elephant Rock Kanarra Falls")', y:'Elephant Rock is at Valley of Fire, not Kanarra Falls. The old name confused two places.', a:'✅ Renamed 2026-05-01. Mom passes Elephant Rock visible from the road at 3:00 PM driving from Atlatl Rock to Fire Wave.', lat:36.430, lng:-114.460 },
    { p:'FIX', t:'Add Coords', w:'Day 15 — Tue May 19', n:'FIX: Spencer Trail — add coordinates', y:'Real and worthwhile hike at Lees Ferry. Coordinates just missing.', a:'Spencer Trail trailhead coordinates: (36.864, -111.586). 3.5 mile round trip.', lat:36.864, lng:-111.586 },
    { p:'FIX', t:'Fix Coords', w:'Day 12 — Sat May 16', n:"FIX: Devil's Garden Hoodoos Utah", y:"Coordinates point to Arches National Park. The Escalante Devil's Garden is a completely different place.", a:"Correct coordinates near Escalante: approx (37.787, -111.396).", lat:37.787, lng:-111.396 },
  ];
